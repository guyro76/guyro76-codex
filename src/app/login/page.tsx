        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          ...
          <div className="relative">
            <input
              ...
              disabled={loading}
              className="w-full px-4 py-2 pl-12 rounded-lg bg-slate-900 border border-slate-700 focus:border-cyan-500 focus:outline-none text-white placeholder-slate-500"
            />
            <button
              type="button"
              ...
              className="absolute inset-y-0 left-0 flex items-center px-3 text-slate-400 hover:text-cyan-400 transition-colors"
            >
              {showPassword ? (
