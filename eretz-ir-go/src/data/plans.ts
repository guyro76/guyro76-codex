 ...
 *
 * מנוסח בלי יפוי: היא באמת בסיסית, ויש בה פרסומות. הורה שיגלה את
 * זה רק אחרי ההורדה ירגיש מרומה — וזו ביקורת של כוכב אחד.
 */
export const FREE_FEATURES = [
  'סיבוב ארץ-עיר מלא, לבד מול השעון',
  'עד 3 סיבובים למשחק',
  'עובד בלי אינטרנט',
  'עם פרסומות בין השלבים'
];
