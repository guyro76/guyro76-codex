  ...
  return (
    <main className="login-page">
      <section className="login-card">
        ...
        {denied && <div className="login-alert" role="alert">החשבון אומת, אך עדיין לא קיבל הרשאה להשתמש במערכת.</div>}
        {message && <div className="login-alert" role="alert">{message}</div>}
        <button className="google-login" type="button" onClick={googleLogin} disabled={busy}><span aria-hidden="true">G</span> המשך באמצעות Google</button>
