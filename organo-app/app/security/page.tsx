    ...
    <InfoPage eyebrow="אבטחה כברירת מחדל" title="אבטחת מידע באורגנו" intro="אורגנו מתוכננת לנתח מידע ציבורי בלבד ולהפחית סיכונים למשתמש, לאתר הנבדק ולתשתית המערכת.">
      <section>
        ...
        <ul>
          ...
          <li>אימות DNS לפני קריאות והפניות כדי לצמצם סיכוני SSRF.</li>
      ...
      <section>
        ...
        <p>כאשר אתר ציבורי חוסם קריאה ישירה, אורגנו עשויה לנסות Reader מרונדר, Proxy ציבורי מוגבל או Google Lighthouse. היעד עובר תחילה בדיקות כתובת ו-DNS, לא נשלחים פרטי התחברות, והתוכן מעובד כטקסט סטטי בלבד.</p>
        <p>תוצאה ממקור חלופי מסומנת כבדיקה מוגבלת. אם כל מקורות הקריאה נחסמים, המערכת מחזירה דו״ח חסימה מעשי במקום להציג תוצאות כאילו בוצעה סריקה מלאה.</p>
      </section>
      <section>
